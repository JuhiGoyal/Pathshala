...
import com.pathshala.repository.ContactUsRepository;
	...
	public String loginUser(HttpSession session, @ModelAttribute("user") User user, Model model) {
		...
		if(isValidUser){
			...
			emailService.sendEmail(user.getEmail(),
					"Login Successful",
					"Dear "+user.getName()+","+"\n\n"
							+ "Congratulations! You have successfully logged in to Pathshala.\n\n"
							+ "Thank you for choosing Pathshala for your learning needs.\n\n"
							+ "Best regards,\n"
							+ "The Pathshala Team ");
